...
let float_factorial n =
   Py.Module.get_function_with_keywords __wrap_namespace "float_factorial"
     [||]
...
let qspline1d_eval ?dx ?x0 ~cj ~newx () =
   Py.Module.get_function_with_keywords __wrap_namespace "qspline1d_eval"
     [||]
     (Wrap_utils.keyword_args [("dx", Wrap_utils.Option.map dx Py.Float.of_float); ("x0", Wrap_utils.Option.map x0 Py.Int.of_int); ("cj", Some(cj |> Np.Obj.to_pyobject)); ("newx", Some(newx |> Np.Obj.to_pyobject))])
     |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
let quadratic x =
...
let fft ?n ?axis ?norm ?overwrite_x ?workers ?plan ~x () =
   Py.Module.get_function_with_keywords __wrap_namespace "fft"
     [||]
     (Wrap_utils.keyword_args [("n", Wrap_utils.Option.map n Py.Int.of_int); ("axis", Wrap_utils.Option.map axis Py.Int.of_int); ("norm", Wrap_utils.Option.map norm Py.String.of_string); ("overwrite_x", Wrap_utils.Option.map overwrite_x Py.Bool.of_bool); ("workers", Wrap_utils.Option.map workers Py.Int.of_int); ("plan", plan); ("x", Some(x |> Np.Obj.to_pyobject))])

let fft2 ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
...
| `S x -> Py.String.of_string x
                       ...
                       |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
let fftn ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
...
let hfft ?n ?axis ?norm ?overwrite_x ?workers ?plan ~x () =
   Py.Module.get_function_with_keywords __wrap_namespace "hfft"
     [||]
     (Wrap_utils.keyword_args [("n", Wrap_utils.Option.map n Py.Int.of_int); ("axis", Wrap_utils.Option.map axis Py.Int.of_int); ("norm", Wrap_utils.Option.map norm Py.String.of_string); ("overwrite_x", Wrap_utils.Option.map overwrite_x Py.Bool.of_bool); ("workers", Wrap_utils.Option.map workers Py.Int.of_int); ("plan", plan); ("x", Some(x |> Np.Obj.to_pyobject))])
     |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
let hfft2 ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
   Py.Module.get_function_with_keywords __wrap_namespace "hfft2"
     [||]
     (Wrap_utils.keyword_args [("s", Wrap_utils.Option.map s (fun ml -> Py.List.of_list_map Py.Int.of_int ml)); ("axes", Wrap_utils.Option.map axes (fun ml -> Py.List.of_list_map Py.Int.of_int ml)); ("norm", Wrap_utils.Option.map norm Py.String.of_string); ("overwrite_x", Wrap_utils.Option.map overwrite_x Py.Bool.of_bool); ("workers", Wrap_utils.Option.map workers Py.Int.of_int); ("plan", plan); ("x", Some(x |> Np.Obj.to_pyobject))])
     |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
let hfftn ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
...
let ifft ?n ?axis ?norm ?overwrite_x ?workers ?plan ~x () =
   Py.Module.get_function_with_keywords __wrap_namespace "ifft"
     [||]
     (Wrap_utils.keyword_args [("n", Wrap_utils.Option.map n Py.Int.of_int); ("axis", Wrap_utils.Option.map axis Py.Int.of_int); ("norm", Wrap_utils.Option.map norm Py.String.of_string); ("overwrite_x", Wrap_utils.Option.map overwrite_x Py.Bool.of_bool); ("workers", Wrap_utils.Option.map workers Py.Int.of_int); ("plan", plan); ("x", Some(x |> Np.Obj.to_pyobject))])

let ifft2 ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
   Py.Module.get_function_with_keywords __wrap_namespace "ifft2"
     [||]
     (Wrap_utils.keyword_args [("s", Wrap_utils.Option.map s (fun ml -> Py.List.of_list_map Py.Int.of_int ml)); ("axes", Wrap_utils.Option.map axes (fun ml -> Py.List.of_list_map Py.Int.of_int ml)); ("norm", Wrap_utils.Option.map norm Py.String.of_string); ("overwrite_x", Wrap_utils.Option.map overwrite_x Py.Bool.of_bool); ("workers", Wrap_utils.Option.map workers Py.Int.of_int); ("plan", plan); ("x", Some(x |> Np.Obj.to_pyobject))])

let ifftn ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
...
let rfft ?n ?axis ?norm ?overwrite_x ?workers ?plan ~x () =
   Py.Module.get_function_with_keywords __wrap_namespace "rfft"
     [||]
     (Wrap_utils.keyword_args [("n", Wrap_utils.Option.map n Py.Int.of_int); ("axis", Wrap_utils.Option.map axis Py.Int.of_int); ("norm", Wrap_utils.Option.map norm Py.String.of_string); ("overwrite_x", Wrap_utils.Option.map overwrite_x Py.Bool.of_bool); ("workers", Wrap_utils.Option.map workers Py.Int.of_int); ("plan", plan); ("x", Some(x ))])

let rfft2 ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
...
| `S x -> Py.String.of_string x
                       ...
                       |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
let rfftn ?s ?axes ?norm ?overwrite_x ?workers ?plan ~x () =
...
| `S x -> Py.String.of_string x
                       ...
                       |> (fun x -> (((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 0)), ((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 1))))
                  let freqz ?a ?worN ?whole ?plot ?fs ?include_nyquist ~b () =
...
| `I x -> Py.Int.of_int x
| `None -> Py.none
)); ("whole", Wrap_utils.Option.map whole Py.Bool.of_bool); ("plot", plot); ("fs", Wrap_utils.Option.map fs Py.Float.of_float); ("include_nyquist", Wrap_utils.Option.map include_nyquist Py.Bool.of_bool); ("b", Some(b |> Np.Obj.to_pyobject))])
                       |> (fun x -> (((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 0)), ((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 1))))
...
let order_filter ~a ~domain ~rank () =
   Py.Module.get_function_with_keywords __wrap_namespace "order_filter"
     ...
     |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
                  let resample ?t ?axis ?window ?domain ~x ~num () =
...
)); ("domain", Wrap_utils.Option.map domain Py.String.of_string); ("x", Some(x |> Np.Obj.to_pyobject)); ("num", Some(num |> Py.Int.of_int))])
     ...
     |> (fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t))
                  let gausspulse ?fc ?bw ?bwr ?tpr ?retquad ?retenv ~t () =
                     Py.Module.get_function_with_keywords __wrap_namespace "gausspulse"
                       [||]
                       (Wrap_utils.keyword_args [("fc", Wrap_utils.Option.map fc Py.Float.of_float); ("bw", Wrap_utils.Option.map bw Py.Float.of_float); ("bwr", Wrap_utils.Option.map bwr Py.Float.of_float); ("tpr", Wrap_utils.Option.map tpr Py.Float.of_float); ("retquad", Wrap_utils.Option.map retquad Py.Bool.of_bool); ("retenv", Wrap_utils.Option.map retenv Py.Bool.of_bool); ("t", Some(t |> (function
| `Ndarray x -> Np.Obj.to_pyobject x
