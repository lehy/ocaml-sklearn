...
let of_pyobject x = ((Obj.of_pyobject x) : t)
let to_pyobject x = Obj.to_pyobject x
let create ?byte_order ?mat_dtype ?squeeze_me ?chars_as_strings ?matlab_compatible ?struct_as_record ?verify_compressed_data_integrity ?uint16_codec ~mat_stream () =
...
let of_pyobject x = ((Obj.of_pyobject x) : t)
let to_pyobject x = Obj.to_pyobject x
let create ?byte_order ?mat_dtype ?squeeze_me ?chars_as_strings ?matlab_compatible ?struct_as_record ?verify_compressed_data_integrity ~mat_stream () =
   Py.Module.get_function_with_keywords __wrap_namespace "MatFileReader"
     [||]
     (Wrap_utils.keyword_args [("byte_order", byte_order); ("mat_dtype", mat_dtype); ("squeeze_me", squeeze_me); ("chars_as_strings", chars_as_strings); ("matlab_compatible", matlab_compatible); ("struct_as_record", struct_as_record); ("verify_compressed_data_integrity", verify_compressed_data_integrity); ("mat_stream", Some(mat_stream ))])
     |> of_pyobject
let end_of_stream self =
   Py.Module.get_function_with_keywords (to_pyobject self) "end_of_stream"
     [||]
...
module Byteord = struct
type tag = [`Int]
type t = [`Int | `Object] Obj.t
let of_pyobject x = ((Obj.of_pyobject x) : t)
let to_pyobject x = Obj.to_pyobject x
let create ?x () =
   Py.Module.get_function_with_keywords __wrap_namespace "byteord"
     [||]
...
let create iterable_of_ints =
   Py.Module.get_function_with_keywords __wrap_namespace "binary_type"
     [||]
...
let to_pyobject x = Obj.to_pyobject x
let create ?object_ () =
   Py.Module.get_function_with_keywords __wrap_namespace "text_type"
     [||]
