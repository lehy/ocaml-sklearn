...
let make_strictly_feasible ?rstep ~x ~lb ~ub () =
   Py.Module.get_function_with_keywords __wrap_namespace "make_strictly_feasible"
     [||]
     (Wrap_utils.keyword_args [("rstep", rstep); ("x", Some(x )); ("lb", Some(lb )); ("ub", Some(ub ))])
...
| `Callable x -> Wrap_utils.id x
)); ("inner_maxiter", inner_maxiter); ("inner_M", inner_M); ("outer_k", Wrap_utils.Option.map outer_k Py.Int.of_int)]) (match kw with None -> [] | Some x -> x))
                       |> of_pyobject
let aspreconditioner self =
   Py.Module.get_function_with_keywords (to_pyobject self) "aspreconditioner"
     [||]
...
| `Minres -> Py.String.of_string "minres"
| `Callable x -> Wrap_utils.id x
)); ("inner_maxiter", inner_maxiter); ("inner_M", inner_M); ("outer_k", Wrap_utils.Option.map outer_k Py.Int.of_int); ("verbose", Wrap_utils.Option.map verbose Py.Bool.of_bool); ("maxiter", Wrap_utils.Option.map maxiter Py.Int.of_int); ("f_tol", Wrap_utils.Option.map f_tol Py.Float.of_float); ("f_rtol", Wrap_utils.Option.map f_rtol Py.Float.of_float); ("x_tol", Wrap_utils.Option.map x_tol Py.Float.of_float); ("x_rtol", Wrap_utils.Option.map x_rtol Py.Float.of_float); ("tol_norm", tol_norm); ("line_search", Wrap_utils.Option.map line_search (function
| `Armijo -> Py.String.of_string "armijo"
| `Wolfe -> Py.String.of_string "wolfe"
| `None -> Py.none
)); ("callback", callback); ("F", Some(f )); ("xin", Some(xin |> Np.Obj.to_pyobject))]) (match kw with None -> [] | Some x -> x))
...
| `None -> Py.none
                  ...
                  let linprog ?a_ub ?b_ub ?a_eq ?b_eq ?bounds ?method_ ?callback ?options ?x0 ~c () =
                     Py.Module.get_function_with_keywords __wrap_namespace "linprog"
                       [||]
                       (Wrap_utils.keyword_args [("A_ub", Wrap_utils.Option.map a_ub Np.Obj.to_pyobject); ("b_ub", Wrap_utils.Option.map b_ub Np.Obj.to_pyobject); ("A_eq", Wrap_utils.Option.map a_eq Np.Obj.to_pyobject); ("b_eq", Wrap_utils.Option.map b_eq Np.Obj.to_pyobject); ("bounds", bounds); ("method", Wrap_utils.Option.map method_ (function
...
)); ("callback", callback); ("options", options); ("x0", Wrap_utils.Option.map x0 Np.Obj.to_pyobject); ("c", Some(c |> Np.Obj.to_pyobject))])
                       |> (fun x -> ((Wrap_utils.id (Py.Tuple.get x 0)), ((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 1)), (Py.Float.to_float (Py.Tuple.get x 2)), ((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 3)), ((fun py -> (Np.Obj.of_pyobject py : [`ArrayLike|`Ndarray|`Object] Np.Obj.t)) (Py.Tuple.get x 4)), (Py.Bool.to_bool (Py.Tuple.get x 5)), (Py.Int.to_int (Py.Tuple.get x 6)), (Py.Int.to_int (Py.Tuple.get x 7)), (Py.String.to_string (Py.Tuple.get x 8))))
