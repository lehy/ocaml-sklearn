...
| `S x -> Py.String.of_string x
                  ...
                  let fclusterdata ?criterion ?metric ?depth ?method_ ?r ~x ~t () =
                     Py.Module.get_function_with_keywords __wrap_namespace "fclusterdata"
                       [||]
                       (Wrap_utils.keyword_args [("criterion", Wrap_utils.Option.map criterion Py.String.of_string); ("metric", Wrap_utils.Option.map metric (function
| `Callable x -> Wrap_utils.id x
| `S x -> Py.String.of_string x
)); ("depth", Wrap_utils.Option.map depth Py.Int.of_int); ("method", Wrap_utils.Option.map method_ Py.String.of_string); ("R", Wrap_utils.Option.map r Np.Obj.to_pyobject); ("X", Some(x |> Np.Obj.to_pyobject)); ("t", Some(t |> (function
| `F x -> Py.Float.of_float x
| `I x -> Py.Int.of_int x
| `Bool x -> Py.Bool.of_bool x
| `S x -> Py.String.of_string x
